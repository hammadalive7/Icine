                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                auth.isSingleSocialAuthEnable(isGoogle: false)?Expanded(child:  SocialLoginButton(
                                    bg: MyColor.fbColor,
                                    text: MyStrings.facebook,
                                    press: (){
                                      auth.signInWithFacebook();
                                    },imageSize: 30,isIcon:false,fromAsset:true,padding: 0,circleSize: 30,imageUrl: MyImages.fbIcon)):const SizedBox.shrink(),
                              ],
                            ),
                          ],
                        ):const SizedBox.shrink(),
